...
<head>
 ...
 -->
    <!-- 引入 jquery-->
    <script type="text/javascript" src="${APP_PATH }/static/js/jquery-1.12.4.min.js.jsp"></script>
    <!-- 引入 Bootstrap 样式-->
    ...
    function build_emps_table(result) {
        ...
        $.each(emps, function (index, item) {
            ...
            var editBtn = $("<button></button>")
                .addClass("btn btn-primary btn-sm edit_btn edit_btn")
                .append($("<span></span>")
            ...
            var delBtn = $("<button></button>")
                .addClass("btn btn-danger btn-sm delete_btn delete_btn")
                .append($("<span></span>")
